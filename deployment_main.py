# Import all function from the python utilities
import os 
import json
import requests
import time 
...
def orchestrator(tenant_id, client_id, client_secret, connections_data):
    ...
    try:
        ...
        if workspace_id is None:  # Only create if it does not exist
            try:                
            ...
            try:
                ...
                # Append the error message for logging or further handling
