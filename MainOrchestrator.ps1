...
function Invoke-ReportDeployment {
    ...
    # Get all PBIX files   
    $reportingPbixFiles = Get-PBIXFiles -ArtifactPath $artifactPath -Folder "ARM/Reporting"
    $operationsPbixFiles = Get-PBIXFiles -ArtifactPath $artifactPath -Folder "ARM/Operations"    
